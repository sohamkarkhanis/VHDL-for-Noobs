...
HD_PWD='G:/Master-Rep/VLSI/Vivado/4bit Binary UpDown Counter/4bit Binary UpDown Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin4updowncounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin4updowncounter.tcl
