...
HD_PWD='G:/Master-Rep/VLSI/Vivado/4bit binary upcounter/4bit binary upcounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin4counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin4counter.tcl
